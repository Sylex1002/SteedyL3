...
import "./Styles/SearchActiveGroupe.scss";
import {
  Avatar,
  AvatarGroup,
  Stack,
...
function SearchMessageGroupeActive({
  messagess,
  baseUrl,
  setFileContent,
  userID,
  ...
  return (
    <>
      <div className="Message-content-active-groupe">
        <div className="box-message-groupe">
          <div className="input-file-active">
            <div className="content-input-active">
              <div className="other-group">
                <div className="other-group-image">
                  ...
                  >
                    {GroupDestMessage[0]?.members.map((membre, index) => {
                      return (
          ...
          <div className="chat-log-active" ref={messagesEndRef}>
            {messagess
              .filter((message) =>
                message.message
                  ?.toLowerCase()
              ...
              .map((message, index) => {
                const isCurrentUser = message.user_sender.id === userID.id;
                if (message.file) {
          ...
          <form
            className="form-submit-active-groupe"
...
export default SearchMessageGroupeActive;
